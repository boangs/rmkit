    ...
    Component {
        ...
        Rectangle {
            ...
            function _aiRun(promptPrefix, actionLabel) {
                ...
                var host = aiMenu.srcBtn ? aiMenu.srcBtn._overlayHost() : aiMenu.Window.window.contentItem
