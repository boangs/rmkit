...
/* [rmkit] 固件 5.8.x (3.28) 移除了 this+0x40 处 0x20 字节的 EPContentMap 成员,
 * 其后成员整体前移 0x20 (反汇编 swapBuffers 核实: EPScreenModeMap 0x60->0x40,
 * 平移表 0x90/0xa0 -> 0x70/0x80)。3.27 原值: SIZE 0x110 / PREV 0xc8 / FB 0xa8 / RT 0xc0 */
#define EPFR_SIZE 0xf0
#define EPFR_OFFSET_PREVIOUSBUFFER 0xa8
#define EPFR_OFFSET_FRAMEBUFFER 0x88
#define EPFR_OFFSET_RENDERTARGET 0xa0
#else
...
/*! [rmkit] 固件 5.8.x (20260702+) 的 libqsgepaper 已移除 EPContentType/EPContentMap 参数; 本头文件按 5.8.202 导出符号修订. */
/*! Content type hint for the framebuffer controller (5.8.x 未导出, 仅保留声明). */
enum EPContentType {
